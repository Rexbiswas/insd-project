...
import BoneyardContainer from './components/BoneyardContainer';
...
function App() {
    ...
    // This will be used inside Router context, so let's move the logic to a sub-component
    // or just use a hook if we can. Actually, we need to be inside <Router>.
                ...
                <RegisterModalProvider>
                    <Router>
                        <Suspense fallback={<WebSkeleton />}>
                            <GlobalBoneyardLoader setIsPageLoading={setIsPageLoading} />
                            <Navbar />
...
const GlobalBoneyardLoader = ({ setIsPageLoading }) => {
    ...
    React.useEffect(() => {
        ...
        }, 1200); // Consistent loading time for perceived performance
