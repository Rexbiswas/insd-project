...
const Photography = () => {
    ...
    return (
        <div className="bg-white min-h-screen font-sans selection:bg-primary selection:text-white">
            <SEO 
                title="Bachelors in Photography | INSD International School of Design"
                description="Master the art of the perfect frame with INSD's professional Photography program. Learn studio lighting, high-fashion shooting, and digital post-production."
            />
                ...
                <div className="relative z-10 max-w-5xl mx-auto space-y-8 flex flex-col items-center">
                    ...
                    >
                        ...
                        <h1 className="text-5xl md:text-8xl font-black text-white uppercase tracking-tighter leading-none mb-6">
                            Bachelors in <br /> <span className="text-primary italic">Photography</span>
                        </h1>
                        <p className="text-lg md:text-xl text-white/80 font-medium leading-relaxed max-w-4xl mx-auto mb-10 text-center uppercase tracking-tight">
                            Master the art of the perfect frame. From high-fashion editorials to cinematic visual stories, learn the technical precision and creative vision required for the global media industry.
                        </p>
                ...
                <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                    <div className="space-y-8">
                        <h2 className="text-4xl md:text-6xl font-black text-slate-900 uppercase tracking-tighter leading-none">
                            The Science of <br /> <span className="text-primary italic">Light</span> Physics
                        </h2>
                        <p className="text-lg text-slate-600 font-medium leading-relaxed uppercase tracking-tight">
                            Engineers the perfect shot. Master the physics of light, advanced studio production, and high-end digital workflows. Our program balances artistic vision with the rigorous technical standards of global media markets.
                        </p>
                        <div className="grid grid-cols-2 gap-6">
                            {[
                                "Studio Lighting", "Fashion Shooting", 
                                "High-End Retouching", "Architecture",
                                "Cinematography", "Media Business"
                            ].map((tech, i) => (
                        ...
                        <p className="text-slate-500 leading-relaxed italic border-l-4 border-primary pl-6 uppercase text-xs font-black tracking-widest">
                            "INSD focuses on the technical vision and professional networking needed for the global media market. It truly prepares you for your career."
                        </p>
                    </div>
            ...
            <section className="py-24 px-6 md:px-12 lg:px-24 bg-slate-50 relative overflow-hidden">
                <div className="max-w-7xl mx-auto space-y-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pb-32">
                        {[
                            { title: "Lighting Physics", desc: "Scientific mastery of light and shadow for world-class high-fashion studio production.", icon: Aperture },
                            { title: "Digital Post Lab", desc: "Advanced retouching and color grading workflows using industry-standard software stacks.", icon: Image },
                            { title: "Cinematic Vision", desc: "Bridging the gap between static imagery and motion through professional digital videography.", icon: Video },
                        ].map((item, idx) => (
                    ...
                    <div className="relative p-12 md:p-24 bg-slate-900 rounded-[3.5rem] overflow-hidden group">
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12 text-center md:text-left">
                            <div className="space-y-4">
                                ...
                                <p className="text-white/50 font-medium max-w-sm uppercase text-xs font-black tracking-widest leading-relaxed">Join the 2026 session. Limited seats for high-potential visual artists.</p>
                            </div>
                            <button 
                                onClick={() => openAdmissionModal()}
