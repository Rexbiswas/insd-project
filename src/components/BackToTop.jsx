        ...
        <AnimatePresence>
            {isVisible && (
                <motion.button
                    ...
                    whileTap={{ scale: 0.9 }}
                    onClick={scrollToTop}
                    className="fixed bottom-[272px] md:bottom-[200px] right-6 md:right-10 z-999 group flex items-center justify-center w-12 h-12 md:w-14 md:h-14 rounded-full shadow-2xl bg-white/90 backdrop-blur-xl border border-slate-200/50 hover:border-primary/50 hover:shadow-primary/20 transition-all duration-300"
