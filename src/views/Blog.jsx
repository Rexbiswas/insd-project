...
const Blog = () => {
    ...
    const filteredPosts = posts.filter(post => {
        ...
        if (typeof window !== 'undefined') {
            try {
                deletedIds = JSON.parse(localStorage.getItem('deleted_blogs') || '[]');
            } catch {}
        }
    ...
    const handleLike = async (e, postId) => {
        ...
        if (typeof window !== 'undefined') {
            try {
                likedBlogs = JSON.parse(localStorage.getItem('liked_blogs') || '[]');
            } catch {}
        }
    ...
    const handleDelete = async (e, postId) => {
        e.stopPropagation();
        if (typeof window !== 'undefined' && !window.confirm("Are you sure you want to delete this blog?")) return;
