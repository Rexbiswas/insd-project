                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center bg-white/5 p-8 md:p-16 rounded-[4rem] border border-white/5 backdrop-blur-sm">
                            ...
                            <div className="lg:col-span-5 space-y-8">
                                ...
                                <div className="flex items-center gap-6">
                                    <Link href="/course-apply-now" className="px-10 py-5 bg-primary text-white rounded-2xl font-black uppercase text-xs tracking-widest hover:bg-white hover:text-slate-950 transition-all text-center shadow-xl shadow-primary/20">Get Vip Entry</Link>
            ...
            <div className="px-6 pb-24">
                ...
                >
                    ...
                    <div className="relative flex flex-col sm:flex-row gap-6">
                        <Link href="/course-apply-now" className="px-12 py-5 bg-primary rounded-full font-black uppercase text-xs tracking-widest hover:scale-105 transition-all shadow-2xl shadow-primary/30">Apply for 2026</Link>
                    </div>
                </motion.div>
            </div>
            <Footer />
